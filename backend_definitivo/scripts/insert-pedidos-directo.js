// Script para insertar pedidos directamente usando SQL
...
const insertSQL = `
-- Insertar clientes
INSERT INTO clientes (id_cliente, dni, cuit_cuil, nombre, apellido, domicilio, telefono, mail, estado) VALUES
...
-- Insertar empleados
INSERT INTO empleados (id_empleado, cuil, nombre, apellido, domicilio, telefono, mail, sueldo, puesto, estado) VALUES
...
-- Insertar productos
INSERT INTO productos (id_producto, descripcion, id_proveedor, id_categoria, stock, precio_venta, precio_compra, stock_seguridad, estado) VALUES
...
-- Insertar pedidos
INSERT INTO pedidos (id_pedido, id_cliente, id_empleados, fecha_pedido, importe, estado, anulacion, venta_web, payment_id) VALUES
(1, 1, 1, '2024-01-15 10:30:00', 11000.00, 'completado', false, false, NULL),
(2, 2, 1, '2024-01-16 14:20:00', 12000.00, 'completado', false, false, NULL),
(3, 3, 1, '2024-01-17 09:15:00', 33000.00, 'procesando', false, false, NULL),
(4, 4, 1, '2024-01-18 16:45:00', 9500.00, 'pendiente', false, false, NULL),
(5, 1, 1, '2024-01-19 11:30:00', 15000.00, 'completado', false, true, 'web_123456789'),
(6, 2, 1, '2024-01-20 13:20:00', 17500.00, 'completado', false, true, 'web_987654321'),
(7, 3, 1, '2024-01-21 15:10:00', 22000.00, 'cancelado', true, false, NULL),
(8, 4, 1, '2024-01-22 10:00:00', 12000.00, 'completado', false, true, 'web_456789123')
ON CONFLICT (id_pedido) DO NOTHING;

-- Insertar detalles de pedidos
INSERT INTO detalle_pedidos (id_pedido, id_producto, precio_venta, cantidad, descuento) VALUES
...
async function insertarDatos() {
    try {
        ...
        console.log('📦 Insertando datos de pedidos...');
        await client.query(insertSQL);
        console.log('✅ Datos insertados exitosamente');

        // Verificar datos insertados
        const result = await client.query('SELECT COUNT(*) as total FROM pedidos');
        console.log(`📊 Total de pedidos en la base de datos: ${result.rows[0].total}`);
